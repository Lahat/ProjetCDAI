			...
			<div class="row">
				<div class="col-md-9">
					<div class="single-blog">
						<article>
                                                    <div class="post-thumb"><img class="img-responsive" src="template/images/blog/04.jpg" alt=""></div>
					...
					<div class="single-blog">
						<article>
							<div class="post-link"><a href="">www.crouss-dauphine.com</a></div>
							<h4 class="post-title"><a href="">Vos reservation de restaurant dans des places de luxe.</a></h4>
						</article>
					</div>
					<hr>
					<div class="single-blog">
						<article>
								...
								<div id="post-carousel" class="carousel slide" data-ride="carousel">			
									<div class="carousel-inner">
										<div class="item active">
                                                                                    <img src="template/images/blog/01.jpg" alt="">
										</div>
										<div class="item">
                                                                                    <img src="template/images/blog/02.jpg" alt="">			
										</div>
										<div class="item">
                                                                                    <img src="template/images/blog/03.jpg" alt="">			
										</div>
							...
							<div class="post-article">
								Sp&eacute;cialiste dans la restauration, ce site de reservation en ligne permet de vous accueillir, et vous accompagne dans les d&eacute;lices des bons plats fait maison.
							</div>
						</article>
					</div>
					<div class="single-blog">
